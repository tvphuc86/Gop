...
const Detailproduct = () => {
    ...
    useEffect(() => {
        axios.get(`https://localhost:44352/api/Product/getById/${param.id}`).then((res) => setProd(res.data.product));
        axios
            .get(`https://localhost:44352/api/User/getProfile?userId=${userId}`)
